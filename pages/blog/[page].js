    ...
    <div>
      ...
      <div className="px-8">
        ...
        <SearchComponent onSearch={handleSearch} currentPage={currentPage} />
          <h1 className="mb-2 text-6xl">Blog</h1>
...
export async function getServerSideProps({ query }) {
  ...
  let url = new URL(`${process.env.API_BASE_URL}/publications?currentPage=${currentPage}`);
  if (search) {
    url.searchParams.append('q', search);
  }
  if (author) {
    url.searchParams.append('authorId', author);
  }
